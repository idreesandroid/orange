                ...
                <div class="sidebar-inner slimscroll">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="deals.php" class="active"><i class="fa fa-podcast" aria-hidden="true"></i> <span>Deals</span></a>
							</li>
							<li> 
							...
							<div class="col text-right">
								<ul class="list-inline-item pl-0">
									...
									<li class="dropdown list-inline-item add-lists">
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" href="deals.php">List View</a>
					                        <a class="dropdown-item" href="deals-kanban-view.php">Kanban View</a>
