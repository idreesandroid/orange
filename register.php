				            ...
				            <div>
				                         ...
				                         <div class="themes">
												<div class="themes-body">
													<ul id="theme-change" class="theme-colors border-0 list-inline-item list-unstyled mb-0">
														...
														<li class="list-inline-item dark-mode">Dark Mode <span class="theme-dark"></span></li>
														
													</ul>
													<a class="reset text-white bg-dark float-right" id="ChangedarkDefault">Reset Default</a>
												</div>
											</div>
				              ...
				              <div>
				                ...
				                <div class="row Default-font">
				                    ...
				                    <div class="col text-right">
				                        <a class="reset text-white bg-dark" onclick="ChangeFontDefault()">Reset Default</a>
				                    </div>
				                </div>
