                ...
                <div class="sidebar-inner slimscroll">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="projects.php" class="active"><i class="fa fa-cubes" aria-hidden="true"></i> <span>Projects</span></a>
							</li>
							<li> 
							...
							<div class="col text-right">
								<ul class="list-inline-item pl-0">
									...
									<li class="dropdown list-inline-item add-lists">
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" href="projects.php">List View</a>
					                        <a class="dropdown-item" href="projects-kanban-view.php">Kanban View</a>
