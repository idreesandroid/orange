...
<html lang="en">
    <head>
        ...
        <title>Blog Detail Page - Auto Coin Cars</title>
                ...
                <div class="sidebar-inner slimscroll">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li class="submenu">
								<a href="#" class="active"><i class="fa fa-file-text-o" aria-hidden="true"></i> <span> Blog </span> <span class="menu-arrow"></span></a>
								<ul class="sub-menus"> 
                ...
                <div class="content container-fluid">
					...
					<div class="crms-title row bg-white mb-4">
                		<div class="col  p-0">
			                ...
			                </span>7 Common Problems People Face When Using Bitcoins  	 </h3>
                		</div>
                		<div class="col p-0 text-right">
                			<ul class="breadcrumb bg-white float-right m-0 pl-0 pr-0">
								<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
								<li class="breadcrumb-item active">Blog Detail Page</li>
							</ul>
                		</div>
                	</div>
					<!-- /Page Header -->
								...
								<div class="card-body">
									<form action="#">
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
												<input type="date" class="form-control" placeholder="Published Date" name="published-date">
											</div>
										</div>
										
										<div class="form-group row">
											<label class="col-form-label col-md-2">Auther</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="Auther" name="auther" value="Auther Name Comes here">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
												...
												<select class="select " aria-hidden="true">
														<option data-select2-id="3">Select</option>
														<option value="1" data-select2-id="autocoin">Autocoin</option>
														<option value="2" data-select2-id="cryptocurrency">Cryptocurrency</option>
														<option value="3" data-select2-id="automotive">Automotive</option>
														<option value="4" data-select2-id="option">Option</option>
													</select>
												</div>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="Add Comma Seprated Tags" name="tags" >
											</div>
										</div>
										
										<div class="form-group row">
											<label class="col-form-label col-md-2">Blog Image</label>
											<div class="col-md-10">
