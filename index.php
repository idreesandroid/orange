...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Auto Coin Cars</title>
                ...
                <div class="sidebar-inner slimscroll">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li class="submenu">
								<a href="#"><i class="fa fa-gavel" aria-hidden="true"></i> <span> Dealer List </span> <span class="menu-arrow"></span></a>
								<ul class="sub-menus"> 
                ...
                <div class="content container-fluid">
					...
					<div class="crms-title row bg-white mb-4">
                		<div class="col">
			                ...
			                </span> <span>Administrator Dashboard</span></h3>
                		</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<div class="info-box"> <span class="info-box-icon bg-yellow"><i class="fa fa-info"></i></span>
								<div class="info-box-content" > <span class="info-box-text">Accounts</span> <span
										class="info-box-number" style="font-size: 12px;">Total Accounts:
										338 </span> <span class="info-box-number" style="font-size: 12px;">Dealer Accounts: <a
											href="#">
											321 </a> </span> 
											<span class="info-box-number" style="font-size: 12px; margin-bottom: 15px;">Private User Accounts:
										17 </span> </div>
						...
						<div class="col-sm-3">
							<div class="info-box"> <span class="info-box-icon bg-yellow"><i class="fa fa-car"></i></span>
								<div class="info-box-content" > <span class="info-box-text">Vehicle Ads</span> <span
										class="info-box-number" style="font-size: 12px;">Total Ads:
										338 </span> <span class="info-box-number" style="font-size: 12px;">Dealer Ads <a
											href="#">
											321 </a> </span> 
											<span class="info-box-number" style="font-size: 12px; margin-bottom: 15px;">Private User Ads:
										17 </span> </div>
						...
						<div class="col-sm-3">
							<div class="info-box"> <span class="info-box-icon bg-yellow"><i class="fa fa-user"></i></span>
								<div class="info-box-content" > <span class="info-box-text">Dealer Ads Lead</span> <span
										class="info-box-number" style="font-size: 12px;">Total Impression:
										338 </span> <span class="info-box-number" style="font-size: 12px;">Total Clicks <a
											href="#">
											321 </a> </span> 
											<span class="info-box-number" style="font-size: 12px; margin-bottom: 15px;">Total Enquires:
										17 </span> </div>
						...
						<div class="col-sm-3">
							<div class="info-box"> <span class="info-box-icon bg-yellow"><i class="fa fa-buysellads"></i></span>
								<div class="info-box-content" > <span class="info-box-text">Dealer Leads</span> <span
										class="info-box-number" style="font-size: 12px;">Total Contact Viewed
										338 </span> <span class="info-box-number" style="font-size: 12px;">Total Website Redirect <a
											href="#">
											321 </a> </span> 
					...
					<div class="row graphs">
						...
						<div class="col-md-6">
							<div class="card h-100">
			                    <div class="card-body">
			                    	<h3 class="card-title">Dealers Leads</h3>
			                      <canvas id="bar-chart-horizontal" width="800" height="450"></canvas>
			                    </div>
			                </div>
						</div>
					</div>
					<div class="row graphs hide-it-now">
						<div class="col-md-6">
							<div class="card h-100">
								<div class="card-body">
					...
					<div class="row graphs" >
						<div class="col-md-6"> 
							<div class="card h-100">
			                    <div class="card-body">
			                      <h3 class="card-title">Dealers Lead Ads</h3>
						...
						<div class="col-md-6 mb-0">
							<div class="card h-100">
								<div class="card-body">
									<h3 class="card-title">Vehicles Ads</h3>
					...
					<div class="row">
						<div class="col-sm-12" style="margin-top:25px;">
							<div style="width: 100%"><iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=323%20HIGH%20ROAD,%20OFFICE%20253,%20ROMFORD,%20RM6%206AX%20,%20UK+(Autocoincars)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div>
						</div>
					</div>
