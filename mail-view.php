            ...
            <div class="sidebar" id="sidebar">
                <div class="sidebar-inner slimscroll">
					...
					<div class="sidebar-menu">
						<ul>
							<li> 
								<a href="index.php"><i class="fa fa-home" aria-hidden="true"></i> <span>Back to Home</span></a>
							</li>
				              <li class="active"> 
				                <a href="email.php"><i class="fa fa-envelope menu-icon" aria-hidden="true"></i> <span>Inbox <span class="mail-count">(21)</span></span></a>
				              </li>
				            <li> 
							...
							<li class="menu-title xs-hidden">Label <a href="#"><i class="fa fa-plus"></i></a></li>
							<li class="xs-hidden"> 
